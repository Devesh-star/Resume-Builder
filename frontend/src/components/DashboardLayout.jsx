...
const DashboardLayout = ({ children, hideSidebar = false }) => {
  ...
  return (
    <div className='min-h-screen bg-app-bg flex'>
      ...
      <aside className={`w-64 bg-white border-r border-app-border fixed top-0 left-0 h-full flex flex-col z-30 transition-transform duration-300 ${mobileSidebarOpen ? 'translate-x-0' : '-translate-x-full'} ${hideSidebar ? 'md:hidden' : 'md:translate-x-0'}`}>
